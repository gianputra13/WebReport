        ...
        <table class="page-break" style="font-family: Arial; font-size:11px; padding: 0 0 0 0;">
            <tr>
                <td width="30%" valign="top">
                    <b> PT. BANK SYARIAH MANDIRI<br />
                        STRUK PEMBELIAN TOKEN PLN</b><br /><br />
                ...
                <td>
                    <table border="0" cellspacing="1" cellpadding='0' style='font-family: Arial; font-size:11px;'>
                        <tr>
                        ...
                        <tr>
                            <td colspan="5" align="center" style='font-size:12px;'><b>PT. BANK SYARIAH MANDIRI<br />
                                    STRUK PEMBELIAN LISTRIK PRABAYAR</b><br /><br /></td>
                        </tr>
                        <tr>
...
<script>
export default {
    props: ['tanggal', 'idMeter', 'materai', 'idPelanggan', 'ppn', 'ppj', 'tarifDaya',
        'angsuran', 'reff', 'token', 'total', 'admin', 'kwh', 'tagihan', 'informasi', 'nama', 'nominal']
}
</script>